...
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := app/UpdateSetting/UpdateSetting.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
...
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := priv-app/OmaDmclient/OmaDmclient.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
...
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := priv-app/SprintHiddenMenu/SprintHiddenMenu.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
